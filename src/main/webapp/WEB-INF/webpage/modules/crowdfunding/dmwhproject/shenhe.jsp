...
<link type="text/css" rel="stylesheet" href="${staticPath}/modules/crowdfunding/css/faqi.css">
<link type="text/css" rel="stylesheet" href="${staticPath}/modules/crowdfunding/css/common.css">
<link type="text/css" rel="stylesheet" href="${staticPath}/modules/crowdfunding/css/project.css">
<link type="text/css" rel="stylesheet" href="${staticPath}/modules/crowdfunding/css/shenhe.css">
<link type="text/css" rel="stylesheet" href="${staticPath}/vendors/sweetalert/sweetalert.css">
<script type="text/javascript" src="${staticPath}/vendors/sweetalert/sweetalert.min.js"></script>
			...
			<div class="fq_body1 xxr5">
			  ...
			  <c:when test="${project.initiatorPersonInfo!=null }">
			   <div class="shenfenBox">
			    ...
			    <div class="imgInfo">
			    			<div><span>身份证正面：</span><div class="imgInfo_item"></div></div>
	                    	<div><span>身份证反面：</span><div class="imgInfo_item"></div></div>
			    	</div>
			   </div>
			   </c:when>
