		...
		<table  class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<form:input path="dateOfBirth" htmlEscape="false" class="form-control"      />
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="idNumber" htmlEscape="false" class="form-control"      />
						<label class="Validform_checktip"></label>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="dateOfRegistration" htmlEscape="false" class="form-control"      />
						<label class="Validform_checktip"></label>
					</td>
				</tr>
