...
public class GeneratorDaoImpl extends CommonDaoImpl implements IGeneratorDao {
	...
	private Connection getConnection() {
		...
		try {
			...
			String dbType = propertiesUtil.getString("connection.dbType1");
			String url = propertiesUtil.getString("connection.url1");
			String username = propertiesUtil.getString("connection.username1");
			String password = propertiesUtil.getString("connection.password1");
